boss_names = ["괴멸의 궤도", "급성 선홍증", "신앙의 이동", "신앙의 이동 II형", "탈피의 잔향"]
BOSS_BG_URLS = {
    "괴멸의 궤도": "https://vkndropbpkorenidgply.supabase.co/storage/v1/object/public/game_assets/rhlaufdmlrnpeh.webp", 
...
HOW_TO_GET_SCORE = {
    "신앙의 이동 II형": "디버프 카드 사용 시마다 보스 피해 감면이 감소하기 때문에 디버프 유형의 카드 자주 사용, 잡몹이 보스에게 버프 주기 때문에 매턴 잡몹 처리, 카드에 기믹 디버프 주문 사용하지 않을 시 카드 2장 동결"
}